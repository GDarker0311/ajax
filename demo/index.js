...
var _srcAjaxJs = require('../src/ajax.js');

var _srcAjaxJs2 = _interopRequireDefault(_srcAjaxJs);

var ajax = new _srcAjaxJs2['default']({
    url: 'data.json'
...
},{"../src/ajax.js":3}],2:[function(require,module,exports){
/**
